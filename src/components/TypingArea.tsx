...
export const TypingArea: React.FC<TypingAreaProps> = ({ text, input, inputRef }) => (
    <div
        ref={inputRef}
        tabIndex={0}
        className="mb-6 p-8 bg-gray-50 dark:bg-gray-900 rounded-lg text-2xl font-mono outline-none relative max-w-4xl mx-auto"
    >
                    ...
                    <span key={index} className="relative inline-block">
                        ...
                        <span
                            className={`${isCurrentPosition
                                ? 'text-gray-800 dark:text-gray-200 bg-blue-200 dark:bg-blue-800 transition-all duration-200 ease-out'
                                : isCorrect
